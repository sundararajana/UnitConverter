// $ANTLR 3.5.1 Expr.g 2014-01-14 21:03:59
...
public class ExprLexer extends Lexer {
	...
	public final void mID() throws RecognitionException {
		try {
			int _type = ID;
			int _channel = DEFAULT_TOKEN_CHANNEL;
			// Expr.g:246:5: ( ( 'a' .. 'z' | 'A' .. 'Z' | '_' ) ( 'a' .. 'z' | 'A' .. 'Z' | '_' | '0' .. '9' )* )
			// Expr.g:246:7: ( 'a' .. 'z' | 'A' .. 'Z' | '_' ) ( 'a' .. 'z' | 'A' .. 'Z' | '_' | '0' .. '9' )*
			{
	...
	public final void mNUMBER() throws RecognitionException {
		try {
			int _type = NUMBER;
			int _channel = DEFAULT_TOKEN_CHANNEL;
			// Expr.g:250:5: ( ( '0' .. '9' )+ ( '.' ( '0' .. '9' )+ )? )
			// Expr.g:250:7: ( '0' .. '9' )+ ( '.' ( '0' .. '9' )+ )?
			{
			// Expr.g:250:7: ( '0' .. '9' )+
			int cnt2=0;
			loop2:
	...
	public void mTokens() throws RecognitionException {
		// Expr.g:1:8: ( T__7 | T__8 | T__9 | T__10 | T__11 | T__12 | T__13 | T__14 | T__15 | T__16 | T__17 | ID | NUMBER | WS )
		int alt5=14;
		switch ( input.LA(1) ) {
		case '(':
			{
